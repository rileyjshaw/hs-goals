...
var terra = new Terrarium( thePlan );
var moody = new LifeLikeTerrarium( moodyCave );

var gen = new LifeLikeTerrarium( levelGen( 24, 40, [ ' ', ' ', ' ', ' ', ' ', '*', '*', '*', '*', '*', 'c', 'c' ] ) );

var loop = setInterval( function() {
  domElement.innerHTML = gen.toString();
  gen.step();
}, 10);
